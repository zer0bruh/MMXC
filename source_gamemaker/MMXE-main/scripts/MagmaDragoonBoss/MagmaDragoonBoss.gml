function MagmaDragoonBoss() : BaseBoss() constructor{

	// this is definitely incomplete. most of the code here is commented out because it is a note.
	// do not uncomment anything! it will not compile!
			...
			.add("hadouken",{
				step: function(){
					...
					*/
					...
					// Palette Swap
					if (t == 0) {
						self.publish("animation_play", { name: "hadouken1" + _c });
						self.face_player();
					}
					if (t < 18)
					...
					// Shoot
					if (t == 18) {
						self.publish("animation_play", { name: "hadouken2" + _c });
...
/*
god this is long. thankfully i can cut some bits out.

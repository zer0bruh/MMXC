...
## The class of the LLM provider resource for that model, e.g. res://addons/ai_autonomous_agent/llm_providers/ollama.tres, if empty it will try to use the API selected in AI Hub tab.
